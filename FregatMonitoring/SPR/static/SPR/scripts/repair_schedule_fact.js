...
function RenderLog(TableData){
  ...
  layout:"fitColumns",
  groupBy:["loc", "eqp", "sect", "node"],
  groupStartOpen:true,
  groupToggleElement:"header",
          columns: [
            {title:"ID", field:"id", hozAlign:"center", width:20, formatter:"textarea"},
            {title:"Работа", field:"work", hozAlign:"center", width:520, formatter:"textarea", editor:per_dateEditor, frozen:true},
            ...
            {title:"Узел", field:"node", hozAlign:"center", width:140, formatter:"textarea", visible:false},
